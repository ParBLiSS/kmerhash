...
//        }
    ...
    void test_insert(int type) {
    	  ...
    	  using MAP = ::fsc::hashmap_robinhood_offsets<T, T>;
...
{
	  using MAP = ::fsc::hashmap_robinhood_offsets<TypeParam, TypeParam>;
...
//    	}
		...
		return ::fsc::hashmap_robinhood_offsets<Kmer, uint32_t, Hash, Equal >();
    }
