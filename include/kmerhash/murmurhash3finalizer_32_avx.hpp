...
public:
  ...
  explicit Murmur32FinalizerAVX(Murmur32FinalizerAVX const &other) : Murmur32FinalizerAVX(other.seed_arr[0])
  {
  }

  explicit Murmur32FinalizerAVX(Murmur32FinalizerAVX &&other) : Murmur32FinalizerAVX(other.seed_arr[0])
  {
  }
