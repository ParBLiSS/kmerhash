 ...
 */
template<typename T>
class Hashtable_OARH_PrefetchTest : public ::testing::Test
{
...
TYPED_TEST_CASE_P(Hashtable_OARH_PrefetchTest);

TYPED_TEST_P(Hashtable_OARH_PrefetchTest, insert_partial)
{
  bool same = false;
...
//TYPED_TEST_P(Hashtable_OARH_PrefetchTest, equal_range_partial)
//{
...
TYPED_TEST_P(Hashtable_OARH_PrefetchTest, count_partial)
{
	  using MAP = ::fsc::hashmap_robinhood_prefetch<TypeParam, TypeParam>;
...
REGISTER_TYPED_TEST_CASE_P(Hashtable_OARH_PrefetchTest, insert_partial,
//		equal_range_partial,
		count_partial);
...
typedef ::testing::Types<uint8_t, uint16_t,
    uint32_t, uint64_t> Hashtable_OARH_PrefetchTestTypes;
INSTANTIATE_TYPED_TEST_CASE_P(Bliss, Hashtable_OARH_PrefetchTest, Hashtable_OARH_PrefetchTestTypes);
 ...
 */
template<typename T>
class Hashmap_OA_RH_Prefetch_KmerTest : public ::testing::Test
{
  protected:
...
//	test.print();
//	for (auto it = entries.begin(); it != entries.begin() + 2; ++it) {
//			test.erase((*it).first);
//			test.print();
//		}
  test.erase(entries.begin(), entries.begin() + entries.size() / 2);
...
// indicate this is a typed test
TYPED_TEST_CASE_P(Hashmap_OA_RH_Prefetch_KmerTest);
...
TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, single_map_insert)
{
...
TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, single_map_insert_integrated)
{
...
//TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, single_map_equal_range)
//{
//
...
TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, single_map_count)
{
  this->template test_map_count<TypeParam, false,
								  ::bliss::transform::identity,
								  HASH_K, std::equal_to, std::less>();
}
TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, single_map_erase)
{
	  this->template test_map_erase<TypeParam, false,
	  ::bliss::transform::identity,
	  									  HASH_K, std::equal_to, std::less>();
}
TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, canonical_map_insert)
{
...
TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, canonical_map_insert_integrated)
{
...
//TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, canonical_map_equal_range)
//{
...
TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, canonical_map_count)
{
...
TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, canonical_map_erase)
{
...
TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, bimolecule_map_insert)
{
	this->template test_map_insert<TypeParam, false,
...
TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, bimolecule_map_insert_integrated)
{
	this->template test_map_insert_integrated<TypeParam, false,
									  ::bliss::kmer::transform::lex_less,
									  HASH_K, std::equal_to, std::less>();
...
//TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, bimolecule_map_equal_range)
//{
//	 this->template test_map_equal_range<TypeParam, false,
//	 ::bliss::kmer::transform::lex_less,
//	 									  HASH_K, std::equal_to, std::less>();
...
TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, bimolecule_map_count)
{
	  this->template test_map_count<TypeParam, false,
	  ::bliss::kmer::transform::lex_less,
	  									  HASH_K, std::equal_to, std::less>();
...
TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, bimolecule_map_erase)
{
	  this->template test_map_erase<TypeParam, false,
	  ::bliss::kmer::transform::lex_less,
	  									  HASH_K, std::equal_to, std::less>();
}
//TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, single_multimap_insert)
//{
////  using SPLITTER = typename std::conditional<((TypeParam::nWords * sizeof(typename TypeParam::KmerWordType) * 8 - TypeParam::nBits) > 1),
...
//
//}
//TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, single_multimap_equal_range)
//{
...
//
//}
//TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, single_multimap_count)
//{
...
//
//
//TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, canonical_multimap_insert)
//{
...
//
//
//TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, canonical_multimap_equal_range)
//{
...
//}
//
//TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, canonical_multimap_count)
//{
...
//}
//
//TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, bimolecule_multimap_insert)
//{
//	this->template test_multimap_insert<TypeParam, false,
//									  ::bliss::kmer::transform::lex_less,
//									  HASH_K, std::equal_to, std::less>();
...
//
//
//TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, bimolecule_multimap_equal_range)
//{
//	this->template test_multimap_equal_range<TypeParam, false,
//									  ::bliss::kmer::transform::lex_less,
//									  HASH_K, std::equal_to, std::less>();
...
//
//
//TYPED_TEST_P(Hashmap_OA_RH_Prefetch_KmerTest, bimolecule_multimap_count)
//{
//	this->template test_multimap_count<TypeParam, false,
//									  ::bliss::kmer::transform::lex_less,
//									  HASH_K, std::equal_to, std::less>();
...
// now register the test cases
REGISTER_TYPED_TEST_CASE_P(Hashmap_OA_RH_Prefetch_KmerTest,
...
typedef ::testing::Types<
		...
		> Hashmap_OA_RH_Prefetch_KmerTestTypes;
INSTANTIATE_TYPED_TEST_CASE_P(Bliss, Hashmap_OA_RH_Prefetch_KmerTest, Hashmap_OA_RH_Prefetch_KmerTestTypes);
