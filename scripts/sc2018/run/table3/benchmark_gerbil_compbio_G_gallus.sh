...
datafiles=(\
${DATA_DIR}/${dataset}/SRR105788_1.fastq  ${DATA_DIR}/${dataset}/SRR105789_1.fastq  ${DATA_DIR}/${dataset}/SRR105792_1.fastq \
${DATA_DIR}/${dataset}/SRR105794_1.fastq  ${DATA_DIR}/${dataset}/SRR197985_1.fastq  ${DATA_DIR}/${dataset}/SRR197986_1.fastq \
${DATA_DIR}/${dataset}/SRR105788_2.fastq  ${DATA_DIR}/${dataset}/SRR105789_2.fastq  ${DATA_DIR}/${dataset}/SRR105792_2.fastq \
${DATA_DIR}/${dataset}/SRR105794_2.fastq  ${DATA_DIR}/${dataset}/SRR197985_2.fastq  ${DATA_DIR}/${dataset}/SRR197986_2.fastq \
)
